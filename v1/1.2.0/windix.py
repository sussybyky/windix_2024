...
filename = r"F:\Daniel\sonstiges\Anderes\Schule\python\.windix\programm files\log_in_data.json"
adfilename = r"F:\Daniel\sonstiges\Anderes\Schule\python\.windix\programm files\log_in_admin.json"
...
def regis():
    ...
    data_admin =  { 
        ...
        "file_dat": {
            ...
            "information": "This is the original file only owned by Daniel Naderer and Levente Racz!"
        }
    }
...
def calender():
    ...
    if typ == "ae":
        ...
        path = r"F:\Daniel\sonstiges\Anderes\Schule\python\.windix\programm files\calender.json"
        ...
        with open(path, "a") as file:
            json.dump(file_dat["save"], file["save"], indent=4)
...
def logged_in():
    ...
    if com == "c":
        ...
        print("-"*14)
        filedat = r"F:\Daniel\sonstiges\Anderes\Schule\python\.windix\programm files\write_text.txt"
...
def programmer_logged_in():
    ...
    if com == "l":
        ...
        filepath = r"F:\Daniel\sonstiges\Anderes\Schule\python\.windix\programm files\log_in_admin.json"
